...
@NamedQueries({
    ...
    @NamedQuery(name = "Pedidos.findByNumSec", query = "SELECT p FROM Pedidos p WHERE p.numSec = :numSec"),
    ...
    @NamedQuery(name = "Pedidos.findByFechaRecepcion", query = "SELECT p FROM Pedidos p WHERE p.fechaRecepcion = :fechaRecepcion"),
    @NamedQuery(name = "Pedidos.findByIndPedido", query = "SELECT p FROM Pedidos p WHERE p.indPedido = :indPedido"),
    @NamedQuery(name = "Pedidos.findByIndRecibido", query = "SELECT p FROM Pedidos p WHERE p.indRecibido = :indRecibido"),
    @NamedQuery(name = "Pedidos.findByIndFacturado", query = "SELECT p FROM Pedidos p WHERE p.indFacturado = :indFacturado"),
    @NamedQuery(name = "Pedidos.findByComentario", query = "SELECT p FROM Pedidos p WHERE p.comentario = :comentario"),
    @NamedQuery(name = "Pedidos.findByFechaEnvio", query = "SELECT p FROM Pedidos p WHERE p.fechaEnvio = :fechaEnvio"),
    @NamedQuery(name = "Pedidos.findByCodigoUsuario", query = "SELECT p FROM Pedidos p WHERE p.codigoUsuario = :codigoUsuario"),
    @NamedQuery(name = "Pedidos.findByFechaPagoAnticipado", query = "SELECT p FROM Pedidos p WHERE p.fechaPagoAnticipado = :fechaPagoAnticipado"),
    @NamedQuery(name = "Pedidos.findByTipoCarta", query = "SELECT p FROM Pedidos p WHERE p.tipoCarta = :tipoCarta"),
    @NamedQuery(name = "Pedidos.findByGastos", query = "SELECT p FROM Pedidos p WHERE p.gastos = :gastos"),
    @NamedQuery(name = "Pedidos.findByTipoIva", query = "SELECT p FROM Pedidos p WHERE p.tipoIva = :tipoIva")})
public class Pedidos implements Serializable {
    ...
    public Pedidos(Integer numSec) {
        this.numSec = numSec;
    }

    public Pedidos(Integer numSec, String numeroPedido, Date fechaPedido) {
        this.numSec = numSec;
    ...
    public String toString() {
        return "com.titus.convierteaviornisasqlite.ant.Pedidos[ numSec=" + numSec + " ]";
    }
